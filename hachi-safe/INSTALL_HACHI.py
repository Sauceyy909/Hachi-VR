...
if ! python3 -c "import tkinter" 2>/dev/null; then
    zenity --error --text="Python tkinter not found!\\n\\nInstall with: sudo dnf install python3-tkinter" 2>/dev/null || \
    kdialog --error "Python tkinter not found! Install with: sudo dnf install python3-tkinter" 2>/dev/null || \
